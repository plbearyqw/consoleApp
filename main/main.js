...
let checkStudent = require('./checkStudent');
let printConsole = require('./printConsole');
...
function main() {
    ...
    while (true) {
        switch (getNumber(getMenu())) {
            case 1:
                let student = checkStudent(question(addMessage));
                while (student === -1) {
            ...
            case 2:
                ...
                let transcript = printConsole(students, noStr);
                while (transcript === -1) {
